...
import (
    ...
    "github.com/tokenbankteam/etherquery/etherquery"
...
func makeDefaultExtra() []byte {
    ...
    if err != nil {
        log.Info("error setting canonical miner information:", err)
    }

    if uint64(len(extra)) > params.MaximumExtraDataSize.Uint64() {
        log.Info("error setting canonical miner information: extra exceeds", params.MaximumExtraDataSize)
        log.Info("extra: %x\n", extra)
        return nil
    }
    return extra
